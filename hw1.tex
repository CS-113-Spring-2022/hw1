...
\question
  ...
  \part[5] Using the insights from above, express $A\oplus B\oplus C$ in the same manner as given in part a). That is, using the set operations: union, intersection, difference and/or complement. Show your working.
    \begin{solution}
      % Enter your solution here.
    \end{solution}
